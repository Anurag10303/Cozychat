    ...
    return (
      ...
      >
        ...
        >
          ...
          <h3 className={`text-2xl font-bold mb-3 ${textColor}`}>Welcome to CozyChat</h3>
          <p
  ...
  return (
    ...
    >
      ...
      <div
        ...
        ${theme === "light" ? "scrollbar-thumb-blue-300" : "scrollbar-thumb-slate-600"}`}
      >
        <Messages />
      </div>
      ...
      <div
        ...
        ${theme === "light" ? "border-gray-200 bg-white/80" : "border-slate-700 bg-slate-800/70"}`}
      >
        <TypeMsg />
      </div>
    </div>
